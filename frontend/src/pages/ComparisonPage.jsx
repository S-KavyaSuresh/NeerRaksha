...
export default function ComparisonPage() {
  ...
  return <><p>Current comparison: prototype breach scenarios.</p><div className="context-note">Predefined comparison estimates at T+60. They are independent sample assumptions, not calculations from edited inputs or the illustrative asset inventory.</div>
